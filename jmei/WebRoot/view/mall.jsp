...
<head>
	...
	<link href="http://www.jubaobar.com/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" />
...
<div class="main clearfix">
    <div class="api-back-res">
		<form method="post" action="http://locolhost:8080/java-demo/goToPay.jsp">
			<table>
				<tr>
					<td>金额:(单位元，精确到分)</td>
				...
				<tr>
					<td>备注:</td>
					<td><input type="text" name="remark" value="商品备注"> (非必填信息)</td>
				</tr>
				<tr>
					<td>支付方式</td>
					<td>
