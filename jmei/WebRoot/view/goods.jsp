 ...
 <!-- 头部搜索框、导航条 -->
    ...
    <div id="shoppingcartdisplay" onmousemove="flu();">
  	...
  	<div id="imginfo" class="w">
	  	<div id="bigimg">
	  		<center><img id="img_0" src="../images/goodspic/3/${sessionScope.BigPic.picpname }" height="400px;" width="570px;"/></center>
	  	</div>
	  	<!-- 商品的基本信息 -->
	  	<div id="info">
	  		...
	  		<!-- 价格 -->
	  			...
	  			<input type="hidden" value="${sessionScope.goods.gid}" id="hid_0">
	  		</div>
	  		...
	  		<div class="button_list">
	  			<a class="button_list_1" id="addcart_0" onclick="addCart(0);"></a>
	  			<div class=""></div>
	  		</div>
