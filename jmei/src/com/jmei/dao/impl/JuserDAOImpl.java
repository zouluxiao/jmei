...
public class JuserDAOImpl implements JuserDAO {
	...
	public Juser queryjUserByJid(int jid)throws DAOException {
		String sql="SELECT JNAME,JPWD,JEMAIL,JTEL,JGENDER,JBIR,juserisval,JPIC "
	...
	public Juser queryJuserByJname(String jname)throws DAOException {
		String sql="SELECT JID,JPWD,JEMAIL,JTEL,JGENDER,JBIR,juserisval,JPIC "
	...
	public Juser queryJuserByJtel(String jtel)throws DAOException {
		String sql="SELECT JID,JNAME,JPWD,JEMAIL,JTEL,JGENDER,JBIR,juserisval,JPIC "
	...
	public Juser queryJuserByJemail(String jemail)throws DAOException {
		String sql="SELECT JID,JNAME,JPWD,JTEL,JGENDER,JBIR,juserisval,JPIC "
	...
	public void updateIsValByjid(int jid, int isVal)throws DAOException {
		String sql="UPDATE JUSER SET juserisval=? WHERE JID=?";
			Connection conn = null;
			PreparedStatement pstmt = null;
			try {
				conn = DBUtils.getConnection();
	...
	public void updateOtherByJid(Juser juser)throws DAOException {
		String sql="UPDATE JUSER SET JGENDER=?,JBIR=?,juserisval=?,JPIC=? WHERE JID=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		try {
			conn = DBUtils.getConnection();
	...
	public void updateJpic(int jid, String jpic) throws DAOException {
		String sql="UPDATE JUSER SET JPIC=? WHERE JID=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		try {
			conn = DBUtils.getConnection();
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, jpic);
			pstmt.setInt(2, jid);
			pstmt.executeUpdate();
